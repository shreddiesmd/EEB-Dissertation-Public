...
This repository contains annotated R code (version 4.6.0), with subsequent model outputs and figures used to assess climatic driver associations with the reproductive success of Southern Giant Petrels and Atlantic Yellow-nosed Albatrosses on Gough Island. 
