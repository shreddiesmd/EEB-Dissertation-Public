...
It does not contain the data provided to complete the project: the climate data are owned by the South African Weather Service, and the breeding data are owned by the Tristain de Cunha government and the Royal Society for the Protection of Birds. 
